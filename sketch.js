...
var fantasma, fantasmaImg, fantasmaImg_2;
...
function preload(){ 
  ...
  fantasmaImg = loadAnimation("ghost-standing.png");
  fantasmaImg_2 = loadAnimation("ghost-standing copy.png");
...
fantasma.addAnimation("esquerda", fantasmaImg) ;
fantasma.scale = 0.4
fantasma.addAnimation("direita", fantasmaImg_2) ;
...
function draw() {
 ...
 if (keyDown("right")) {
  fantasma.x += 3
  fantasma.changeAnimation("direita")
 }
 if (keyDown("left")) {
  fantasma.x -= 3
  fantasma.changeAnimation("esquerda")
 }
